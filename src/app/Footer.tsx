          ...
          <div className="flex flex-col md:flex-row md:space-x-16">
            <div className="mb-6 md:mb-0">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="/about" className="hover:text-gray-300 transition duration-300 transform hover:translate-x-1">About Us</a>
                </li>
                <li>
                  <a href="/products" className="hover:text-gray-300 transition duration-300 transform hover:translate-x-1">Products</a>
                </li>
                <li>
                  <a href="/contact" className="hover:text-gray-300 transition duration-300 transform hover:translate-x-1">Contact</a>
                </li>
              </ul>
            </div>
            <div>
